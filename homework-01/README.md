...
- Сделай импорт модулей `fs` (в версии, которая работает с промисами - `fs/promises`) и `path` для работы с файловой системой
...
Также в файл README.md нужно добавить ссылку на репозиторий со сделанной работой.
